        ...
        <FadeIn>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "16px", maxWidth: "700px", margin: "0 auto" }}>
            ...
            <a href="mailto:sukrit@roadtoivies.com?subject=Strategic%20Counseling%20Inquiry" 
               style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", padding: "16px", background: "#ea4335", color: "#ffffff", fontWeight: 600, fontSize: "14px", textDecoration: "none", borderRadius: "4px", textTransform: "uppercase", letterSpacing: "0.05em" }}>
              <svg style={{ width: "18px", height: "18px", fill: "currentColor" }} viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/in/sukrit-tripathi" 
               target="_blank" 
               rel="noopener noreferrer" 
               style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", padding: "16px", background: "#0077b5", color: "#ffffff", fontWeight: 600, fontSize: "14px", textDecoration: "none", borderRadius: "4px", textTransform: "uppercase", letterSpacing: "0.05em" }}>
              <svg style={{ width: "18px", height: "18px", fill: "currentColor" }} viewBox="0 0 24 24">
