...
function evaluateProfile({ grade, citizenship, major, academic, testing }) {
  ...
  if (citizenship === "india") {
    ...
    if (major === "stem" || major === "finance") {
      vulnerability = "<strong>The saturated-pool problem.</strong> For an Indian citizen targeting STEM or quantitative tracks, a 'well-rounded' portfolio is usually the wrong positioning strategy. You are competing directly against thousands of applicants with similar profiles. Your child's application needs an undeniable asymmetric spike to stand out.";
